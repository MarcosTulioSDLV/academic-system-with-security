...
* The original package name 'com.springboot.academic-system-with-security' is invalid and this project uses 'com.springboot.academic_system_with_security' instead.
